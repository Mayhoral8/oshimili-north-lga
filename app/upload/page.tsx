...
const DocumentUploadWithCrop = () => {
  ...
  const [croppedAreaPixels, setCroppedAreaPixels] = useState<CropArea | null>(null);
    const { uploadMode, setUploadMode, setCurrentStep } = useContext(CreateContext).portal;
  ...
  const canProceed = hasFile && (!uploadedFile || uploadedFile.success) && !isUploading;
    ...
    <div className="w-full mx-auto p-8 h-screen flex flex-col lg:justify-center bg-gray-50">
      <div className="max-w-2xl mx-auto w-full">
        ...
        <button
          ...
          disabled={!canProceed}
          className="w-full bg-blue-500 hover:bg-blue-600 text-white font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center disabled:bg-gray-400 disabled:cursor-not-allowed"
        >
          {isUploading ? (
            <>
